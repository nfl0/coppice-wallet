...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1603761779;
...
fn wire__crate__api__names__begin_names_management_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "begin_names_management",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            let api_payment_address = <Option<String>>::sse_decode(&mut deserializer);
            let api_mnemonic_bytes = <Vec<u8>>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::names::begin_names_management(
                        api_db_path,
                        api_lightwalletd_url,
                        api_network,
                        api_account_uuid,
...
fn wire__crate__api__names__begin_names_registration_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_send_flow_id = <String>::sse_decode(&mut deserializer);
            let api_name = <String>::sse_decode(&mut deserializer);
            let api_payment_address = <String>::sse_decode(&mut deserializer);
            let api_mnemonic_bytes = <Vec<u8>>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse::<_, String>((move || {
...
impl SseDecode for crate::api::names::ApiManagedName {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_name = <String>::sse_decode(deserializer);
...
impl SseDecode for crate::api::names::ApiNamesBondStatus {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_state = <String>::sse_decode(deserializer);
        let mut var_requiredZatoshi = <u64>::sse_decode(deserializer);
        let mut var_exactNoteCount = <u32>::sse_decode(deserializer);
        let mut var_spendableIronwoodZatoshi = <u64>::sse_decode(deserializer);
        return crate::api::names::ApiNamesBondStatus {
            state: var_state,
            required_zatoshi: var_requiredZatoshi,
            exact_note_count: var_exactNoteCount,
            spendable_ironwood_zatoshi: var_spendableIronwoodZatoshi,
        };
    }
}

impl SseDecode for crate::api::names::ApiNamesCommitProposal {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_proposalId = <u64>::sse_decode(deserializer);
        let mut var_feeZatoshi = <u64>::sse_decode(deserializer);
        let mut var_commitment = <Vec<u8>>::sse_decode(deserializer);
        return crate::api::names::ApiNamesCommitProposal {
...
impl SseDecode for crate::api::names::ApiNamesRegistrationDraft {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_phase = <String>::sse_decode(deserializer);
        return crate::api::names::ApiNamesRegistrationDraft { phase: var_phase };
    }
}

impl SseDecode for crate::api::names::ApiNamesResolution {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
...
impl SseDecode for crate::api::names::ApiNamesRevealProposal {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_proposalId = <u64>::sse_decode(deserializer);
        let mut var_feeZatoshi = <u64>::sse_decode(deserializer);
        return crate::api::names::ApiNamesRevealProposal {
            proposal_id: var_proposalId,
            fee_zatoshi: var_feeZatoshi,
        };
    }
...
impl SseDecode for crate::api::names::ApiNamesWalletStatus {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_state = <String>::sse_decode(deserializer);
        ...
        let mut var_tipHeight = <u64>::sse_decode(deserializer);
        let mut var_namesActivationHeight = <u64>::sse_decode(deserializer);
        let mut var_oldestRewindHeight = <u64>::sse_decode(deserializer);
        return crate::api::names::ApiNamesWalletStatus {
            state: var_state,
            message: var_message,
            configured: var_configured,
            tip_height: var_tipHeight,
            names_activation_height: var_namesActivationHeight,
            oldest_rewind_height: var_oldestRewindHeight,
        };
    }
}
...
impl SseDecode for Vec<crate::api::names::ApiManagedName> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut len_ = <i32>::sse_decode(deserializer);
        let mut ans_ = vec![];
        for idx_ in 0..len_ {
            ans_.push(<crate::api::names::ApiManagedName>::sse_decode(
                deserializer,
            ));
        }
        return ans_;
...
5 => wire__crate__api__names__begin_names_management_impl(port, ptr, rust_vec_len, data_len),
6 => wire__crate__api__names__begin_names_registration_impl(port, ptr, rust_vec_len, data_len),
7 => wire__crate__api__names__begin_names_reveal_impl(port, ptr, rust_vec_len, data_len),
9 => wire__crate__api__names__bootstrap_names_impl(port, ptr, rust_vec_len, data_len),
10 => wire__crate__api__sync__broadcast_due_orchard_migration_transactions_impl(port, ptr, rust_vec_len, data_len),
11 => wire__crate__api__sync__broadcast_one_due_orchard_migration_transaction_impl(port, ptr, rust_vec_len, data_len),
12 => wire__crate__api__voting__build_keystone_delegation_requests_impl(port, ptr, rust_vec_len, data_len),
13 => wire__crate__api__voting__build_prove_and_sign_delegation_payload_with_progress_impl(port, ptr, rust_vec_len, data_len),
14 => wire__crate__api__voting__build_prove_delegation_payload_with_keystone_signature_with_progress_impl(port, ptr, rust_vec_len, data_len),
15 => wire__crate__api__voting__build_vote_commitments_with_progress_impl(port, ptr, rust_vec_len, data_len),
17 => wire__crate__api__voting__check_voting_eligibility_impl(port, ptr, rust_vec_len, data_len),
...
27 => wire__crate__api__voting__confirm_delegation_submission_impl(port, ptr, rust_vec_len, data_len),
28 => wire__crate__api__voting__confirm_vote_submission_impl(port, ptr, rust_vec_len, data_len),
...
44 => wire__crate__api__voting__delegation_submission_wire_json_impl(port, ptr, rust_vec_len, data_len),
...
86 => wire__crate__api__sync__get_next_available_address_impl(port, ptr, rust_vec_len, data_len),
87 => wire__crate__api__sync__get_next_subtree_indices_impl(port, ptr, rust_vec_len, data_len),
88 => wire__crate__api__sync__get_orchard_migration_immediate_plan_impl(port, ptr, rust_vec_len, data_len),
89 => wire__crate__api__sync__get_orchard_migration_private_plan_impl(port, ptr, rust_vec_len, data_len),
90 => wire__crate__api__sync__get_orchard_migration_status_impl(port, ptr, rust_vec_len, data_len),
91 => wire__crate__api__sync__get_orchard_migration_statuses_impl(port, ptr, rust_vec_len, data_len),
92 => wire__crate__api__sync__get_previous_transaction_count_for_address_impl(port, ptr, rust_vec_len, data_len),
93 => wire__crate__api__wallet__get_recent_transparent_receive_addresses_impl(port, ptr, rust_vec_len, data_len),
94 => wire__crate__api__voting__get_round_plan_impl(port, ptr, rust_vec_len, data_len),
95 => wire__crate__api__voting__get_round_recovery_state_impl(port, ptr, rust_vec_len, data_len),
96 => wire__crate__api__sync__get_shield_transparent_status_impl(port, ptr, rust_vec_len, data_len),
98 => wire__crate__api__sync__get_sync_status_impl(port, ptr, rust_vec_len, data_len),
99 => wire__crate__api__sync__get_transaction_data_requests_impl(port, ptr, rust_vec_len, data_len),
100 => wire__crate__api__sync__get_transaction_detail_impl(port, ptr, rust_vec_len, data_len),
101 => wire__crate__api__sync__get_transaction_history_impl(port, ptr, rust_vec_len, data_len),
102 => wire__crate__api__wallet__get_transparent_receive_address_impl(port, ptr, rust_vec_len, data_len),
103 => wire__crate__api__wallet__get_unified_address_impl(port, ptr, rust_vec_len, data_len),
105 => wire__crate__api__wallet__import_hardware_account_impl(port, ptr, rust_vec_len, data_len),
106 => wire__crate__api__wallet__import_software_account_at_index_impl(port, ptr, rust_vec_len, data_len),
107 => wire__crate__api__wallet__import_software_wallet_with_account_discovery_impl(port, ptr, rust_vec_len, data_len),
108 => wire__crate__api__wallet__import_wallet_impl(port, ptr, rust_vec_len, data_len),
109 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
112 => wire__crate__api__wallet__is_software_wallet_link_account_imported_impl(port, ptr, rust_vec_len, data_len),
116 => wire__crate__api__sync__keystone_migration_proof_status_impl(port, ptr, rust_vec_len, data_len),
118 => wire__crate__api__wallet__list_accounts_impl(port, ptr, rust_vec_len, data_len),
119 => wire__crate__api__voting__list_pending_share_rounds_impl(port, ptr, rust_vec_len, data_len),
120 => wire__crate__api__names__manage_name_impl(port, ptr, rust_vec_len, data_len),
...
133 => wire__crate__api__names__prepare_names_registration_draft_impl(port, ptr, rust_vec_len, data_len),
134 => wire__crate__api__sync__prepare_orchard_migration_batch_pczt_impl(port, ptr, rust_vec_len, data_len),
135 => wire__crate__api__sync__prepare_orchard_migration_denominations_pczt_impl(port, ptr, rust_vec_len, data_len),
136 => wire__crate__api__sync__prepare_orchard_migration_immediate_pczt_impl(port, ptr, rust_vec_len, data_len),
137 => wire__crate__api__sync__prepare_orchard_migration_outbox_impl(port, ptr, rust_vec_len, data_len),
138 => wire__crate__api__sync__prepare_orchard_migration_single_qr_pczt_impl(port, ptr, rust_vec_len, data_len),
139 => wire__crate__api__wallet__preview_software_account_transparent_balance_impl(port, ptr, rust_vec_len, data_len),
140 => wire__crate__api__sync__propose_send_impl(port, ptr, rust_vec_len, data_len),
141 => wire__crate__api__sync__put_subtree_roots_impl(port, ptr, rust_vec_len, data_len),
142 => wire__crate__api__network_privacy__quiesce_network_privacy_direct_requests_impl(port, ptr, rust_vec_len, data_len),
143 => wire__crate__api__sync__reconcile_orchard_migration_outbox_receipt_impl(port, ptr, rust_vec_len, data_len),
144 => wire__crate__api__voting__record_share_delegation_impl(port, ptr, rust_vec_len, data_len),
145 => wire__crate__api__voting__recover_vote_commitment_impl(port, ptr, rust_vec_len, data_len),
146 => wire__crate__api__voting__recovered_vote_share_wire_json_impl(port, ptr, rust_vec_len, data_len),
147 => wire__crate__api__sync__redact_pczt_for_signer_impl(port, ptr, rust_vec_len, data_len),
149 => wire__crate__api__voting__reset_vote_tree_impl(port, ptr, rust_vec_len, data_len),
150 => wire__crate__api__voting__reset_voting_session_state_impl(port, ptr, rust_vec_len, data_len),
151 => wire__crate__api__names__resolve_name_impl(port, ptr, rust_vec_len, data_len),
...
156 => wire__crate__api__names__reveal_names_registration_impl(port, ptr, rust_vec_len, data_len),
...
161 => wire__crate__api__voting__set_ballot_intent_impl(port, ptr, rust_vec_len, data_len),
164 => wire__crate__api__sync__set_transaction_status_impl(port, ptr, rust_vec_len, data_len),
165 => wire__crate__api__voting__setup_delegation_bundles_impl(port, ptr, rust_vec_len, data_len),
166 => wire__crate__api__voting__share_resubmission_server_order_impl(port, ptr, rust_vec_len, data_len),
168 => wire__crate__api__voting__share_tracking_flags_impl(port, ptr, rust_vec_len, data_len),
169 => wire__crate__api__sync__shield_transparent_balance_impl(port, ptr, rust_vec_len, data_len),
170 => wire__crate__api__sync__shield_transparent_balance_with_macos_stored_mnemonic_impl(port, ptr, rust_vec_len, data_len),
171 => wire__crate__api__sync__start_full_sync_impl(port, ptr, rust_vec_len, data_len),
172 => wire__crate__api__sync__start_mempool_observer_impl(port, ptr, rust_vec_len, data_len),
173 => wire__crate__api__network_privacy__start_tor_update_relay_impl(port, ptr, rust_vec_len, data_len),
175 => wire__crate__api__network_privacy__stop_tor_update_relay_impl(port, ptr, rust_vec_len, data_len),
...
186 => wire__crate__api__voting__trusted_voting_round_params_from_config_impl(port, ptr, rust_vec_len, data_len),
187 => wire__crate__api__sync__update_chain_tip_impl(port, ptr, rust_vec_len, data_len),
188 => wire__crate__api__sync__validate_address_impl(port, ptr, rust_vec_len, data_len),
190 => wire__crate__api__voting__vote_commitment_wire_json_impl(port, ptr, rust_vec_len, data_len),
191 => wire__crate__api__voting__vote_share_wire_json_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        8 => wire__crate__api__network_privacy__begin_network_privacy_enable_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__crate__api__sync__cancel_full_sync_impl(ptr, rust_vec_len, data_len),
        24 => wire__crate__api__names__configure_names_impl(ptr, rust_vec_len, data_len),
        51 => wire__crate__api__names__discard_names_registration_workflow_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        82 => wire__crate__api__names__get_managed_names_impl(ptr, rust_vec_len, data_len),
        83 => wire__crate__api__names__get_names_bond_status_impl(ptr, rust_vec_len, data_len),
        84 => wire__crate__api__names__get_names_status_impl(ptr, rust_vec_len, data_len),
        85 => wire__crate__api__network_privacy__get_network_privacy_status_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        97 => wire__crate__api__sync__get_sync_mode_impl(ptr, rust_vec_len, data_len),
        104 => wire__crate__api__simple__greet_impl(ptr, rust_vec_len, data_len),
        110 => wire__crate__api__voting__is_last_moment_impl(ptr, rust_vec_len, data_len),
        111 => {
            wire__crate__api__sync__is_mempool_observer_running_impl(ptr, rust_vec_len, data_len)
        }
        113 => wire__crate__api__sync__is_sync_cancel_requested_impl(ptr, rust_vec_len, data_len),
        114 => wire__crate__api__sync__is_sync_running_impl(ptr, rust_vec_len, data_len),
        115 => wire__crate__api__network_privacy__is_tor_enabled_impl(ptr, rust_vec_len, data_len),
        117 => {
        ...
        148 => wire__crate__api__keystone__reset_ur_session_impl(ptr, rust_vec_len, data_len),
        160 => wire__crate__api__sync__set_active_sync_account_impl(ptr, rust_vec_len, data_len),
        162 => wire__crate__api__network_privacy__set_network_privacy_dormant_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        163 => wire__crate__api__sync__set_sync_mode_impl(ptr, rust_vec_len, data_len),
        167 => wire__crate__api__voting__share_server_selection_policy_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        174 => wire__crate__api__sync__stop_mempool_observer_impl(ptr, rust_vec_len, data_len),
        ...
        189 => wire__crate__api__wallet__validate_mnemonic_impl(ptr, rust_vec_len, data_len),
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::names::ApiManagedName {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            self.name.into_into_dart().into_dart(),
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::names::ApiManagedName
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::names::ApiManagedName>
    for crate::api::names::ApiManagedName
{
    fn into_into_dart(self) -> crate::api::names::ApiManagedName {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::names::ApiNamesBondStatus {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            self.state.into_into_dart().into_dart(),
            self.required_zatoshi.into_into_dart().into_dart(),
            self.exact_note_count.into_into_dart().into_dart(),
            self.spendable_ironwood_zatoshi.into_into_dart().into_dart(),
        ]
        .into_dart()
    }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::names::ApiNamesBondStatus
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::names::ApiNamesBondStatus>
    for crate::api::names::ApiNamesBondStatus
{
    fn into_into_dart(self) -> crate::api::names::ApiNamesBondStatus {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::names::ApiNamesCommitProposal {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::names::ApiNamesCommitProposal
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::names::ApiNamesCommitProposal>
    for crate::api::names::ApiNamesCommitProposal
{
    fn into_into_dart(self) -> crate::api::names::ApiNamesCommitProposal {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::names::ApiNamesRegistrationDraft {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [self.phase.into_into_dart().into_dart()].into_dart()
    }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::names::ApiNamesRegistrationDraft
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::names::ApiNamesRegistrationDraft>
    for crate::api::names::ApiNamesRegistrationDraft
{
    fn into_into_dart(self) -> crate::api::names::ApiNamesRegistrationDraft {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::names::ApiNamesResolution {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::names::ApiNamesResolution
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::names::ApiNamesResolution>
    for crate::api::names::ApiNamesResolution
{
    fn into_into_dart(self) -> crate::api::names::ApiNamesResolution {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::names::ApiNamesRevealProposal {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            self.proposal_id.into_into_dart().into_dart(),
            self.fee_zatoshi.into_into_dart().into_dart(),
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::names::ApiNamesRevealProposal
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::names::ApiNamesRevealProposal>
    for crate::api::names::ApiNamesRevealProposal
{
    fn into_into_dart(self) -> crate::api::names::ApiNamesRevealProposal {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::names::ApiNamesWalletStatus {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            self.state.into_into_dart().into_dart(),
            ...
            self.tip_height.into_into_dart().into_dart(),
            self.names_activation_height.into_into_dart().into_dart(),
            self.oldest_rewind_height.into_into_dart().into_dart(),
        ]
        .into_dart()
    }
}
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive
    for crate::api::names::ApiNamesWalletStatus
{
}
impl flutter_rust_bridge::IntoIntoDart<crate::api::names::ApiNamesWalletStatus>
    for crate::api::names::ApiNamesWalletStatus
{
    fn into_into_dart(self) -> crate::api::names::ApiNamesWalletStatus {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
...
impl SseEncode for crate::api::names::ApiManagedName {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <String>::sse_encode(self.name, serializer);
...
impl SseEncode for crate::api::names::ApiNamesBondStatus {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <String>::sse_encode(self.state, serializer);
        <u64>::sse_encode(self.required_zatoshi, serializer);
        <u32>::sse_encode(self.exact_note_count, serializer);
        <u64>::sse_encode(self.spendable_ironwood_zatoshi, serializer);
    }
}

impl SseEncode for crate::api::names::ApiNamesCommitProposal {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
...
impl SseEncode for crate::api::names::ApiNamesRegistrationDraft {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <String>::sse_encode(self.phase, serializer);
    }
...
impl SseEncode for crate::api::names::ApiNamesResolution {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
...
impl SseEncode for crate::api::names::ApiNamesRevealProposal {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <u64>::sse_encode(self.proposal_id, serializer);
        <u64>::sse_encode(self.fee_zatoshi, serializer);
...
impl SseEncode for crate::api::names::ApiNamesWalletStatus {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <String>::sse_encode(self.state, serializer);
        ...
        <u64>::sse_encode(self.tip_height, serializer);
        <u64>::sse_encode(self.names_activation_height, serializer);
        <u64>::sse_encode(self.oldest_rewind_height, serializer);
    }
}
...
impl SseEncode for Vec<crate::api::names::ApiManagedName> {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        <i32>::sse_encode(self.len() as _, serializer);
        for item in self {
            <crate::api::names::ApiManagedName>::sse_encode(item, serializer);
        }
    }
}
