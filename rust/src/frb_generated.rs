...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 282964884;
...
fn wire__crate__api__names__recover_names_registration_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "recover_names_registration",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, String>((move || {
                    let output_ok = crate::api::names::recover_names_registration(
                        api_db_path,
                        api_lightwalletd_url,
                        api_network,
                        api_account_uuid,
...
145 => wire__crate__api__names__recover_names_registration_impl(port, ptr, rust_vec_len, data_len),
146 => wire__crate__api__voting__recover_vote_commitment_impl(port, ptr, rust_vec_len, data_len),
147 => wire__crate__api__voting__recovered_vote_share_wire_json_impl(port, ptr, rust_vec_len, data_len),
...
152 => wire__crate__api__names__resolve_name_impl(port, ptr, rust_vec_len, data_len),
...
157 => wire__crate__api__names__reveal_names_registration_impl(port, ptr, rust_vec_len, data_len),
158 => wire__crate__api__sync__rewind_to_height_impl(port, ptr, rust_vec_len, data_len),
159 => wire__crate__api__sync__run_full_sync_blocking_impl(port, ptr, rust_vec_len, data_len),
...
167 => wire__crate__api__voting__share_resubmission_server_order_impl(port, ptr, rust_vec_len, data_len),
169 => wire__crate__api__voting__share_tracking_flags_impl(port, ptr, rust_vec_len, data_len),
170 => wire__crate__api__sync__shield_transparent_balance_impl(port, ptr, rust_vec_len, data_len),
171 => wire__crate__api__sync__shield_transparent_balance_with_macos_stored_mnemonic_impl(port, ptr, rust_vec_len, data_len),
172 => wire__crate__api__sync__start_full_sync_impl(port, ptr, rust_vec_len, data_len),
173 => wire__crate__api__sync__start_mempool_observer_impl(port, ptr, rust_vec_len, data_len),
174 => wire__crate__api__network_privacy__start_tor_update_relay_impl(port, ptr, rust_vec_len, data_len),
176 => wire__crate__api__network_privacy__stop_tor_update_relay_impl(port, ptr, rust_vec_len, data_len),
177 => wire__crate__api__sync__store_and_broadcast_signed_pczts_for_proposal_impl(port, ptr, rust_vec_len, data_len),
178 => wire__crate__api__voting__store_keystone_signature_impl(port, ptr, rust_vec_len, data_len),
179 => wire__crate__api__voting__store_keystone_signatures_batch_impl(port, ptr, rust_vec_len, data_len),
...
192 => wire__crate__api__voting__vote_share_wire_json_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        168 => wire__crate__api__voting__share_server_selection_policy_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        175 => wire__crate__api__sync__stop_mempool_observer_impl(ptr, rust_vec_len, data_len),
