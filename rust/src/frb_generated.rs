...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1496889298;
...
65 => wire__crate__api__voting__generate_van_witness_impl(port, ptr, rust_vec_len, data_len),
...
92 => wire__crate__api__voting__get_round_recovery_state_impl(port, ptr, rust_vec_len, data_len),
93 => wire__crate__api__sync__get_shield_transparent_status_impl(port, ptr, rust_vec_len, data_len),
95 => wire__crate__api__sync__get_sync_status_impl(port, ptr, rust_vec_len, data_len),
96 => wire__crate__api__sync__get_transaction_data_requests_impl(port, ptr, rust_vec_len, data_len),
97 => wire__crate__api__sync__get_transaction_detail_impl(port, ptr, rust_vec_len, data_len),
98 => wire__crate__api__sync__get_transaction_history_impl(port, ptr, rust_vec_len, data_len),
99 => wire__crate__api__wallet__get_transparent_receive_address_impl(port, ptr, rust_vec_len, data_len),
100 => wire__crate__api__wallet__get_unified_address_impl(port, ptr, rust_vec_len, data_len),
102 => wire__crate__api__wallet__import_hardware_account_impl(port, ptr, rust_vec_len, data_len),
103 => wire__crate__api__wallet__import_software_account_at_index_impl(port, ptr, rust_vec_len, data_len),
104 => wire__crate__api__wallet__import_software_wallet_with_account_discovery_impl(port, ptr, rust_vec_len, data_len),
105 => wire__crate__api__wallet__import_wallet_impl(port, ptr, rust_vec_len, data_len),
106 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
109 => wire__crate__api__wallet__is_software_wallet_link_account_imported_impl(port, ptr, rust_vec_len, data_len),
113 => wire__crate__api__sync__keystone_migration_proof_status_impl(port, ptr, rust_vec_len, data_len),
115 => wire__crate__api__wallet__list_accounts_impl(port, ptr, rust_vec_len, data_len),
116 => wire__crate__api__voting__list_pending_share_rounds_impl(port, ptr, rust_vec_len, data_len),
117 => wire__crate__api__names__manage_name_v1_impl(port, ptr, rust_vec_len, data_len),
118 => wire__crate__api__voting__mark_delegation_submitted_impl(port, ptr, rust_vec_len, data_len),
119 => wire__crate__api__voting__mark_share_confirmed_impl(port, ptr, rust_vec_len, data_len),
...
127 => wire__crate__api__voting__plan_share_submissions_impl(port, ptr, rust_vec_len, data_len),
128 => wire__crate__api__voting__precompute_delegation_pir_impl(port, ptr, rust_vec_len, data_len),
129 => wire__crate__api__voting__precompute_snapshot_bundles_impl(port, ptr, rust_vec_len, data_len),
130 => wire__crate__api__names__prepare_names_v1_registration_draft_impl(port, ptr, rust_vec_len, data_len),
131 => wire__crate__api__sync__prepare_orchard_migration_batch_pczt_impl(port, ptr, rust_vec_len, data_len),
132 => wire__crate__api__sync__prepare_orchard_migration_denominations_pczt_impl(port, ptr, rust_vec_len, data_len),
133 => wire__crate__api__sync__prepare_orchard_migration_immediate_pczt_impl(port, ptr, rust_vec_len, data_len),
134 => wire__crate__api__sync__prepare_orchard_migration_outbox_impl(port, ptr, rust_vec_len, data_len),
135 => wire__crate__api__sync__prepare_orchard_migration_single_qr_pczt_impl(port, ptr, rust_vec_len, data_len),
136 => wire__crate__api__wallet__preview_software_account_transparent_balance_impl(port, ptr, rust_vec_len, data_len),
137 => wire__crate__api__sync__propose_send_impl(port, ptr, rust_vec_len, data_len),
138 => wire__crate__api__sync__put_subtree_roots_impl(port, ptr, rust_vec_len, data_len),
139 => wire__crate__api__network_privacy__quiesce_network_privacy_direct_requests_impl(port, ptr, rust_vec_len, data_len),
140 => wire__crate__api__sync__reconcile_orchard_migration_outbox_receipt_impl(port, ptr, rust_vec_len, data_len),
141 => wire__crate__api__voting__record_share_delegation_impl(port, ptr, rust_vec_len, data_len),
142 => wire__crate__api__voting__recover_vote_commitment_impl(port, ptr, rust_vec_len, data_len),
143 => wire__crate__api__voting__recovered_vote_share_wire_json_impl(port, ptr, rust_vec_len, data_len),
...
148 => wire__crate__api__names__resolve_name_v1_impl(port, ptr, rust_vec_len, data_len),
149 => wire__crate__api__voting__resolve_static_voting_config_impl(port, ptr, rust_vec_len, data_len),
150 => wire__crate__api__voting__resolve_voting_config_from_attempts_impl(port, ptr, rust_vec_len, data_len),
151 => wire__crate__api__sync__retain_proposal_lock_until_expiry_impl(port, ptr, rust_vec_len, data_len),
152 => wire__crate__api__sync__retire_unbroadcast_orchard_migration_impl(port, ptr, rust_vec_len, data_len),
153 => wire__crate__api__names__reveal_names_v1_registration_impl(port, ptr, rust_vec_len, data_len),
154 => wire__crate__api__sync__rewind_to_height_impl(port, ptr, rust_vec_len, data_len),
155 => wire__crate__api__sync__run_full_sync_blocking_impl(port, ptr, rust_vec_len, data_len),
156 => wire__crate__api__sync__scan_blocks_impl(port, ptr, rust_vec_len, data_len),
...
163 => wire__crate__api__voting__share_resubmission_server_order_impl(port, ptr, rust_vec_len, data_len),
165 => wire__crate__api__voting__share_tracking_flags_impl(port, ptr, rust_vec_len, data_len),
166 => wire__crate__api__sync__shield_transparent_balance_impl(port, ptr, rust_vec_len, data_len),
167 => wire__crate__api__sync__shield_transparent_balance_with_macos_stored_mnemonic_impl(port, ptr, rust_vec_len, data_len),
168 => wire__crate__api__sync__start_full_sync_impl(port, ptr, rust_vec_len, data_len),
169 => wire__crate__api__sync__start_mempool_observer_impl(port, ptr, rust_vec_len, data_len),
170 => wire__crate__api__network_privacy__start_tor_update_relay_impl(port, ptr, rust_vec_len, data_len),
172 => wire__crate__api__network_privacy__stop_tor_update_relay_impl(port, ptr, rust_vec_len, data_len),
173 => wire__crate__api__sync__store_and_broadcast_signed_pczts_for_proposal_impl(port, ptr, rust_vec_len, data_len),
174 => wire__crate__api__voting__store_keystone_signature_impl(port, ptr, rust_vec_len, data_len),
175 => wire__crate__api__voting__store_keystone_signatures_batch_impl(port, ptr, rust_vec_len, data_len),
176 => wire__crate__api__sync__suggest_scan_ranges_impl(port, ptr, rust_vec_len, data_len),
177 => wire__crate__api__voting__sync_vote_tree_impl(port, ptr, rust_vec_len, data_len),
180 => wire__crate__api__network_privacy__tor_http_download_impl(port, ptr, rust_vec_len, data_len),
181 => wire__crate__api__network_privacy__tor_http_get_impl(port, ptr, rust_vec_len, data_len),
182 => wire__crate__api__network_privacy__tor_http_post_impl(port, ptr, rust_vec_len, data_len),
...
188 => wire__crate__api__voting__vote_share_wire_json_impl(port, ptr, rust_vec_len, data_len),
191 => wire__crate__api__voting__warm_pir_proof_cache_impl(port, ptr, rust_vec_len, data_len),
193 => wire__crate__api__sync__write_block_metadata_impl(port, ptr, rust_vec_len, data_len),
194 => wire__crate__api__keystone__zcash_sign_batch_round_message_counts_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        64 => wire__crate__api__wallet__generate_mnemonic_impl(ptr, rust_vec_len, data_len),
        71 => wire__crate__api__sync__get_blocks_dir_impl(ptr, rust_vec_len, data_len),
        79 => wire__crate__api__names__get_managed_names_v1_impl(ptr, rust_vec_len, data_len),
        80 => wire__crate__api__names__get_names_v1_bond_status_impl(ptr, rust_vec_len, data_len),
        81 => wire__crate__api__names__get_names_v1_status_impl(ptr, rust_vec_len, data_len),
        82 => wire__crate__api__network_privacy__get_network_privacy_status_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        94 => wire__crate__api__sync__get_sync_mode_impl(ptr, rust_vec_len, data_len),
        101 => wire__crate__api__simple__greet_impl(ptr, rust_vec_len, data_len),
        107 => wire__crate__api__voting__is_last_moment_impl(ptr, rust_vec_len, data_len),
        108 => {
            wire__crate__api__sync__is_mempool_observer_running_impl(ptr, rust_vec_len, data_len)
        }
        110 => wire__crate__api__sync__is_sync_cancel_requested_impl(ptr, rust_vec_len, data_len),
        111 => wire__crate__api__sync__is_sync_running_impl(ptr, rust_vec_len, data_len),
        112 => wire__crate__api__network_privacy__is_tor_enabled_impl(ptr, rust_vec_len, data_len),
        114 => {
        ...
        164 => wire__crate__api__voting__share_server_selection_policy_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        171 => wire__crate__api__sync__stop_mempool_observer_impl(ptr, rust_vec_len, data_len),
        178 => wire__crate__api__network_privacy__tor_http_begin_request_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        179 => wire__crate__api__network_privacy__tor_http_cancel_request_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        186 => wire__crate__api__wallet__validate_mnemonic_impl(ptr, rust_vec_len, data_len),
        189 => wire__crate__api__wallet__wallet_exists_impl(ptr, rust_vec_len, data_len),
        190 => {
