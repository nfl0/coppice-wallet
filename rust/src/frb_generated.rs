...
17 => wire__crate__api__voting__clear_recovery_state_impl(port, ptr, rust_vec_len, data_len),
18 => wire__crate__api__sync__complete_orchard_migration_batch_pczt_impl(port, ptr, rust_vec_len, data_len),
19 => wire__crate__api__sync__complete_orchard_migration_denominations_pczt_impl(port, ptr, rust_vec_len, data_len),
20 => wire__crate__api__sync__complete_orchard_migration_immediate_pczt_impl(port, ptr, rust_vec_len, data_len),
21 => wire__crate__api__sync__complete_orchard_migration_single_qr_pczt_impl(port, ptr, rust_vec_len, data_len),
22 => wire__crate__api__simple__configure_fast_testnet_migration_impl(port, ptr, rust_vec_len, data_len),
...
67 => wire__crate__api__voting__generate_van_witness_impl(port, ptr, rust_vec_len, data_len),
...
123 => wire__crate__api__sync__migrate_orchard_to_ironwood_impl(port, ptr, rust_vec_len, data_len),
124 => wire__crate__api__sync__migrate_orchard_to_ironwood_immediately_impl(port, ptr, rust_vec_len, data_len),
125 => wire__crate__api__sync__migrate_orchard_to_ironwood_with_macos_stored_mnemonic_impl(port, ptr, rust_vec_len, data_len),
127 => wire__crate__api__voting__next_share_tracking_delay_seconds_impl(port, ptr, rust_vec_len, data_len),
128 => wire__crate__api__keystone__pczt_spend_nullifiers_impl(port, ptr, rust_vec_len, data_len),
...
136 => wire__crate__api__sync__prepare_orchard_migration_outbox_impl(port, ptr, rust_vec_len, data_len),
137 => wire__crate__api__sync__prepare_orchard_migration_single_qr_pczt_impl(port, ptr, rust_vec_len, data_len),
...
143 => wire__crate__api__voting__record_share_delegation_impl(port, ptr, rust_vec_len, data_len),
144 => wire__crate__api__voting__recover_vote_commitment_impl(port, ptr, rust_vec_len, data_len),
145 => wire__crate__api__voting__recovered_vote_share_wire_json_impl(port, ptr, rust_vec_len, data_len),
...
160 => wire__crate__api__voting__set_ballot_intent_impl(port, ptr, rust_vec_len, data_len),
163 => wire__crate__api__sync__set_transaction_status_impl(port, ptr, rust_vec_len, data_len),
164 => wire__crate__api__voting__setup_delegation_bundles_impl(port, ptr, rust_vec_len, data_len),
165 => wire__crate__api__voting__share_resubmission_server_order_impl(port, ptr, rust_vec_len, data_len),
167 => wire__crate__api__voting__share_tracking_flags_impl(port, ptr, rust_vec_len, data_len),
...
178 => wire__crate__api__sync__suggest_scan_ranges_impl(port, ptr, rust_vec_len, data_len),
179 => wire__crate__api__voting__sync_vote_tree_impl(port, ptr, rust_vec_len, data_len),
182 => wire__crate__api__network_privacy__tor_http_download_impl(port, ptr, rust_vec_len, data_len),
183 => wire__crate__api__network_privacy__tor_http_get_impl(port, ptr, rust_vec_len, data_len),
184 => wire__crate__api__network_privacy__tor_http_post_impl(port, ptr, rust_vec_len, data_len),
185 => wire__crate__api__voting__trusted_voting_round_params_from_config_impl(port, ptr, rust_vec_len, data_len),
186 => wire__crate__api__sync__update_chain_tip_impl(port, ptr, rust_vec_len, data_len),
187 => wire__crate__api__sync__validate_address_impl(port, ptr, rust_vec_len, data_len),
189 => wire__crate__api__voting__vote_commitment_wire_json_impl(port, ptr, rust_vec_len, data_len),
190 => wire__crate__api__voting__vote_share_wire_json_impl(port, ptr, rust_vec_len, data_len),
193 => wire__crate__api__voting__warm_pir_proof_cache_impl(port, ptr, rust_vec_len, data_len),
195 => wire__crate__api__sync__write_block_metadata_impl(port, ptr, rust_vec_len, data_len),
196 => wire__crate__api__keystone__zcash_sign_batch_round_message_counts_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        7 => wire__crate__api__network_privacy__begin_network_privacy_enable_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        ...
        126 => wire__crate__api__wallet__mnemonic_word_list_impl(ptr, rust_vec_len, data_len),
        147 => wire__crate__api__keystone__reset_ur_session_impl(ptr, rust_vec_len, data_len),
        159 => wire__crate__api__sync__set_active_sync_account_impl(ptr, rust_vec_len, data_len),
        161 => wire__crate__api__network_privacy__set_network_privacy_dormant_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        162 => wire__crate__api__sync__set_sync_mode_impl(ptr, rust_vec_len, data_len),
        166 => wire__crate__api__voting__share_server_selection_policy_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        173 => wire__crate__api__sync__stop_mempool_observer_impl(ptr, rust_vec_len, data_len),
        180 => wire__crate__api__network_privacy__tor_http_begin_request_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        181 => wire__crate__api__network_privacy__tor_http_cancel_request_impl(
            ptr,
            rust_vec_len,
            data_len,
        ),
        188 => wire__crate__api__wallet__validate_mnemonic_impl(ptr, rust_vec_len, data_len),
        191 => wire__crate__api__wallet__wallet_exists_impl(ptr, rust_vec_len, data_len),
        192 => {
