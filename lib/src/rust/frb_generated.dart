...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 282964884;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<ApiNamesRevealProposal> crateApiNamesBeginNamesManagement({
    required String dbPath,
    required String lightwalletdUrl,
    required String network,
    required String accountUuid,
  ...
  Future<void> crateApiNamesRecoverNamesRegistration({
    required String dbPath,
    required String lightwalletdUrl,
    required String network,
    required String accountUuid,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_opt_String(paymentAddress, serializer);
        ...
        constMeta: kCrateApiNamesBeginNamesManagementConstMeta,
        argValues: [
          dbPath,
          lightwalletdUrl,
          network,
  ...
  TaskConstMeta get kCrateApiNamesBeginNamesManagementConstMeta =>
      const TaskConstMeta(
        debugName: "begin_names_management",
        argNames: [
          "dbPath",
          "lightwalletdUrl",
          "network",
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(sendFlowId, serializer);
          sse_encode_String(name, serializer);
          sse_encode_String(paymentAddress, serializer);
          sse_encode_list_prim_u_8_loose(mnemonicBytes, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
  ...
  Future<void> crateApiNamesRecoverNamesRegistration({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiNamesRecoverNamesRegistrationConstMeta,
        argValues: [
          dbPath,
          lightwalletdUrl,
          network,
  ...
  TaskConstMeta get kCrateApiNamesRecoverNamesRegistrationConstMeta =>
      const TaskConstMeta(
        debugName: "recover_names_registration",
        argNames: [
          "dbPath",
          "lightwalletdUrl",
          "network",
  ...
  ApiNamesBondStatus dco_decode_api_names_bond_status(dynamic raw) {
    ...
    if (arr.length != 4)
      throw Exception('unexpected arr length: expect 4 but see ${arr.length}');
    return ApiNamesBondStatus(
      state: dco_decode_String(arr[0]),
      requiredZatoshi: dco_decode_u_64(arr[1]),
      exactNoteCount: dco_decode_u_32(arr[2]),
      spendableIronwoodZatoshi: dco_decode_u_64(arr[3]),
    );
  }
  ...
  ApiNamesCommitProposal dco_decode_api_names_commit_proposal(dynamic raw) {
    ...
    if (arr.length != 3)
      throw Exception('unexpected arr length: expect 3 but see ${arr.length}');
    return ApiNamesCommitProposal(
      proposalId: dco_decode_u_64(arr[0]),
      feeZatoshi: dco_decode_u_64(arr[1]),
      commitment: dco_decode_list_prim_u_8_strict(arr[2]),
    );
  }
  ...
  ApiNamesRegistrationDraft dco_decode_api_names_registration_draft(
    ...
    return ApiNamesRegistrationDraft(phase: dco_decode_String(arr[0]));
  }
  ...
  ApiNamesWalletStatus dco_decode_api_names_wallet_status(dynamic raw) {
    ...
    if (arr.length != 6)
      throw Exception('unexpected arr length: expect 6 but see ${arr.length}');
    return ApiNamesWalletStatus(
      state: dco_decode_String(arr[0]),
      message: dco_decode_String(arr[1]),
      configured: dco_decode_bool(arr[2]),
      tipHeight: dco_decode_u_64(arr[3]),
      namesActivationHeight: dco_decode_u_64(arr[4]),
      oldestRewindHeight: dco_decode_u_64(arr[5]),
    );
  }
  ...
  List<ApiManagedName> dco_decode_list_api_managed_name(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>).map(dco_decode_api_managed_name).toList();
  }
  ...
  ApiNamesBondStatus sse_decode_api_names_bond_status(
    ...
    var var_requiredZatoshi = sse_decode_u_64(deserializer);
    var var_exactNoteCount = sse_decode_u_32(deserializer);
    var var_spendableIronwoodZatoshi = sse_decode_u_64(deserializer);
    return ApiNamesBondStatus(
      state: var_state,
      requiredZatoshi: var_requiredZatoshi,
      exactNoteCount: var_exactNoteCount,
      spendableIronwoodZatoshi: var_spendableIronwoodZatoshi,
    );
  }
  ...
  ApiNamesRegistrationDraft sse_decode_api_names_registration_draft(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_phase = sse_decode_String(deserializer);
    return ApiNamesRegistrationDraft(phase: var_phase);
  }
  ...
  ApiNamesWalletStatus sse_decode_api_names_wallet_status(
    ...
    var var_tipHeight = sse_decode_u_64(deserializer);
    var var_namesActivationHeight = sse_decode_u_64(deserializer);
    var var_oldestRewindHeight = sse_decode_u_64(deserializer);
    return ApiNamesWalletStatus(
      state: var_state,
      message: var_message,
      configured: var_configured,
      tipHeight: var_tipHeight,
      namesActivationHeight: var_namesActivationHeight,
      oldestRewindHeight: var_oldestRewindHeight,
    );
  }
  ...
  List<ApiManagedName> sse_decode_list_api_managed_name(
    ...
    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <ApiManagedName>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_api_managed_name(deserializer));
    }
    return ans_;
  }
  ...
  void sse_encode_api_names_bond_status(
    ...
    sse_encode_u_64(self.requiredZatoshi, serializer);
    sse_encode_u_32(self.exactNoteCount, serializer);
    sse_encode_u_64(self.spendableIronwoodZatoshi, serializer);
  }
  ...
  void sse_encode_api_names_wallet_status(
    ...
    sse_encode_u_64(self.tipHeight, serializer);
    sse_encode_u_64(self.namesActivationHeight, serializer);
    sse_encode_u_64(self.oldestRewindHeight, serializer);
  }
  ...
  void sse_encode_list_api_managed_name(
    ...
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_api_managed_name(item, serializer);
    }
  }
